## Gintoki has been very lazy recently and he hasn't made enough money to pay the rent this month. 
## So the old landlady has given him a problem to solve instead, if he can solve this problem the rent will be waived. The problem is as follows:
